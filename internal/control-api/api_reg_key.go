...
type ApiUpdateRegKeyRequest struct {
	...
	ApiService *RegKeyApiService
	id         string
	update     *ModelsUpdateRegKey
}

// RegKey Update
func (r ApiUpdateRegKeyRequest) Update(update ModelsUpdateRegKey) ApiUpdateRegKeyRequest {
	r.update = &update
	return r
}

func (r ApiUpdateRegKeyRequest) Execute() (*ModelsRegKey, *http.Response, error) {
	return r.ApiService.UpdateRegKeyExecute(r)
}
...
*/
func (a *RegKeyApiService) UpdateRegKey(ctx context.Context, id string) ApiUpdateRegKeyRequest {
	return ApiUpdateRegKeyRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *RegKeyApiService) UpdateRegKeyExecute(r ApiUpdateRegKeyRequest) (*ModelsRegKey, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RegKeyApiService.UpdateRegKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
